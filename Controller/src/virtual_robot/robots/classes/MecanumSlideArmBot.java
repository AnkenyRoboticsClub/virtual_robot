 ...
 * a BNO055IMU, and an slider arm with a grabber on the end.
 *
 ...
 */
@BotConfig(name = "Slide Arm Bot", filename = "slide_arm_bot")
public class MecanumSlideArmBot extends MecanumPhysicsBase {
